        ...
        devServer: {
                ...
                client: {
                        webSocketURL:
                                ...
                                // current page's protocol + port instead of the dev server's
                                // local values. This ensures the HMR connection can succeed
                                // when TLS terminates in front of webpack-dev-server.
                                "auto://0.0.0.0:0/ws"
                },
                https: env.secure ? {
